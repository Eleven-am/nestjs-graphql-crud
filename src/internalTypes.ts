...
/**
 * Extended interface for query options with additional Prisma-style parameters
 */
...
> {
	 ...
	 */
	findMany(ability: AppAbilityType, args: any, select: any): Promise<Item[]>;
	 ...
	 * @param {any} select - Fields to select in the result
	 * @param {any} [where] - Optional filter criteria
